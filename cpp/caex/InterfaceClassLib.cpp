...
InterfaceClassLib::InterfaceClassLib()
{
    ...
    /*PROTECTED REGION ID(InterfaceClassLibImpl__InterfaceClassLibImpl) START*/
...
/*PROTECTED REGION ID(InterfaceClassLib.cpp) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
/*PROTECTED REGION END*/
...
// Attributes
// References
::ecorecpp::mapping::EList< ::caex::InterfaceClass >& InterfaceClassLib::getInterfaceClass()
{
